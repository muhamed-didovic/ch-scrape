...
const getCourseMaterialsUrl = (p, zip, code) => {
  let materials = p
  ...
  /*{
     l: 'https://dls2.coursehunter.net/s/8f0d890f4d165f03d908144d2cbf0dbf/adb-dbopp.zip',
     m: 'https://vsss5.coursehunter.net/adb-dbopp/code.zip'
  }*/
  return Object.values(materials).filter(c => c).map(url => url.replace('vsss5.', 'vss5.'))
};
